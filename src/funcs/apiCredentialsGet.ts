...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1ApiCredentialsGetApiCredentialRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.V1ApiCredentialsGetApiCredentialResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
