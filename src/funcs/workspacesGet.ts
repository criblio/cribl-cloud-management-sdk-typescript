...
export function workspacesGet(
  ...
  Result<
    operations.V1WorkspacesGetWorkspaceResponse,
    | CriblMgmtPlaneError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V1WorkspacesGetWorkspaceResponse$inboundSchema),
    M.fail("4XX"),
    M.fail([500, "5XX"]),
    M.json(
      "default",
      operations.V1WorkspacesGetWorkspaceResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
