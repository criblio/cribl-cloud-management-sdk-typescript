...
export function workspacesCreate(
  ...
  Result<
    operations.V1WorkspacesCreateWorkspaceResponse,
    | CriblMgmtPlaneError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.V1WorkspacesCreateWorkspaceResponse$inboundSchema),
    M.fail("4XX"),
    M.fail([500, "5XX"]),
    M.json(
      "default",
      operations.V1WorkspacesCreateWorkspaceResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
