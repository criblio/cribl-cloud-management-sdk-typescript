 ...
 */
export function billingGetContractsUtilization(
  client: CriblMgmtPlaneCore,
  request: operations.V1BillingGetContractsUtilizationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.V1BillingGetContractsUtilizationResponse,
    | CriblMgmtPlaneError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1BillingGetContractsUtilizationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc(
    "/v1/organizations/{organizationId}/billing/credits/contracts-utilization",
  )(pathParams);
  ...
  >(
    M.json(
      200,
      operations.V1BillingGetContractsUtilizationResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail([503, "5XX"]),
    M.json(
